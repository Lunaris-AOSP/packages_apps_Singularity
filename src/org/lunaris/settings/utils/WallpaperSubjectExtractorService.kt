...
import org.lunaris.settings.utils.PortraitSegmenter
...
class WallpaperSubjectExtractorService : Service() {
    ...
    companion object {
        @JvmField
        val ACTION_EXTRACT_NOW = "org.lunaris.intent.action.EXTRACT_DEPTH_SUBJECT_NOW"
    }
    ...
    private fun saveForeground(foreground: Bitmap): String? {
        return try {
            ...
            val dir = File(baseDir, "Lunaris-OS/depthwallpaper")
