...
class DynamicBar : SettingsPreferenceFragment() {
    ...
    private fun updateKeyguardSubPrefsVisibility(keyguardEnabled: Boolean) {
        ...
        findPreference<Preference>(SETTINGS_KEY_HIDE_ON_FOREGROUND)?.isVisible = keyguardEnabled
    }
    ...
    companion object {
        ...
        private const val SETTINGS_KEY_HIDE_ON_FOREGROUND = "ax_dynamic_bar_hide_on_foreground"
        ...
        fun reset(context: Context) {
            ...
            Settings.Secure.putIntForUser(
                resolver, SETTINGS_KEY_HIDE_ON_FOREGROUND, 0,
                UserHandle.USER_CURRENT
            )
        }
    }
