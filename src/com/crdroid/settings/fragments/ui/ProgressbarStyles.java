...
public class ProgressbarStyles extends SettingsPreferenceFragment {

    private RecyclerView mRecyclerView;
    private ThemeUtils mThemeUtils;
    private String mCategory = "android.theme.customization.progress_bar";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getActivity().setTitle(R.string.theme_customization_progressbar_title);
    ...
    public class Adapter extends RecyclerView.Adapter<Adapter.CustomViewHolder> {
        ...
        public CustomViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.progressbar_option, parent, false);
        ...
        public void onBindViewHolder(CustomViewHolder holder, final int position) {
            ...
            holder.name.setText("android".equals(navPkg) ? "Default" : getLabel(holder.name.getContext(), navPkg));
